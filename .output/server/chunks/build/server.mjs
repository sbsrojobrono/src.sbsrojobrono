...
import { $ as $fetch, w as withQuery, l as hasProtocol, p as parseURL, m as isScriptProtocol, n as joinURL, o as klona, q as defu, r as sanitizeStatusCode, t as defuFn, v as createHooks, h as createError$1, x as isSamePath, y as toRouteMatcher, z as createRouter$1 } from '../runtime.mjs';
...
const plugin_mDLvN651dt = /* @__PURE__ */ defineNuxtPlugin((_nuxtApp) => {
  const options = (/* @__PURE__ */ useRuntimeConfig()).public.tailwindIcons;
  const appConfig = useAppConfig();
  appConfig.nuxtIcon = defu(options, appConfig.nuxtIcon);
  if (appConfig.nuxtIcon)
    appConfig.nuxtIcon.resolvedPrefixes = options == null ? void 0 : options.resolvedPrefixes;
});
const plugins = [
  unhead_KgADcZ0jPj,
  plugin,
